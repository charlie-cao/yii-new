                        ...
                        <div class="widget-header">
                            ...
                            <div class="widget-toolbar no-border">
                                <ul class="nav nav-tabs" id="recent-tab">
                                    <li class="active">
                                        <a data-toggle="tab" href="index.html#task-tab">Tasks</a>
                                    </li>

                                    <li>
                                        <a data-toggle="tab" href="index.html#member-tab">Members</a>
                                    </li>

                                    <li>
                                        <a data-toggle="tab" href="index.html#comment-tab">Comments</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                            ...
                                            <li class="item-default clearfix">
                                                ...
                                                <div class="inline pull-right position-relative dropdown-hover">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-caret dropdown-close pull-right">
                                                        <li>
                                                            <a href="index.html#" class="tooltip-success" data-rel="tooltip" title="Mark&nbsp;as&nbsp;done">
                                                                <span class="green">
                                                        ...
                                                        <li>
                                                            <a href="index.html#" class="tooltip-error" data-rel="tooltip" title="Delete">
                                                                <span class="red">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="inline position-relative">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                                <li>
                                                                    <a href="index.html#" class="tooltip-success" data-rel="tooltip" title="Approve">
                                                                        <span class="green">
                                                                            <i class="icon-ok bigger-110"></i>
                                                                        </span>
                                                                    </a>
                                                                ...
                                                                <li>
                                                                    <a href="index.html#" class="tooltip-warning" data-rel="tooltip" title="Reject">
                                                                        <span class="orange">
                                ...
                                <div class="dialogs">
                                    <div class="itemdiv dialogdiv">
                                        ...
                                        <div class="body">
                                            ...
                                            <div class="name">
                                                <a href="index.html#">Alexa</a>
                                            </div>
                                            <div class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque commodo massa sed ipsum porttitor facilisis.</div>

                                            <div class="tools">
                                                <a href="index.html#" class="btn btn-minier btn-info">
